                            ...
                            <div className="relative rounded-xl border border-slate-700/80 bg-[#1a232e] p-4 shadow-[0_12px_28px_rgba(0,0,0,0.16)] sm:p-5">
                                ...
                                <div className="grid grid-cols-7 gap-2">
                                    ...
                                    {daysInMonth.map((date) => {
                                        ...
                                        const availabilityFillStyle = availabilityFillRateStyle(
                                            availableCount,
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="space-y-1 mt-1">
                                                    ...
                                                    {availableCount > 0 && (
                                                        <div className={clsx("flex items-center gap-1 text-[10px] font-semibold", availabilityFillStyle.text)}>
                                                            <span aria-hidden="true" className={clsx("size-2 shrink-0 rounded-full", availabilityFillStyle.dot)} />
                                                            {availableCount}/{groupDetail.members.length}
                                                        </div>
                                                    )}
                                            ...
                                            {selectedGroupSession && (
                                                <div className="rounded-md border border-amber-200/25 bg-amber-200/[0.09] px-3 py-2 text-xs text-amber-100">
                                                    ...
                                                    {selectedGroupSession.start_time && (
                                                        <p className="mt-1 flex flex-wrap items-center gap-1 text-[11px] text-amber-100/80"><Clock3 size={12} /> {selectedGroupSession.start_time.slice(0, 5)} · {selectedGroupSession.duration_minutes} min · {groupDetail.timezone}</p>
                                                    )}
